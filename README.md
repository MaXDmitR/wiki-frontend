...
* **Styling:** Sass (SCSS) (гнучка сітка та кастомні стилі).
* **UI/UX Components:**
...
* **Динамічна система статей:** Повноцінна сторінка статті з розподілом на основний контент, медіа-галереї та допоміжні бічні панелі, а також можливість редагувати статті зареєстрованим користувачам.
...
| :--- | :--- |
| **Максим Дмитренко** | **Lead / Frontend Developer / UI Designer.** Дизайн у Figma, архітектура проєкту, структура файлів, налаштування API запитів до бекенду, виправлення багів, керування репозиторієм . |
| **Максим Дробот** | **Frontend Developer.** Логіка хедера, стан авторизації (Auth State), анімовані меню та робота сторінкою редагування. |
| **Валерій Гашук** | **Frontend Developer.** Верстка центральної частини статті та розробка форм реєстрації/входу, робота сторінкою редагування. |
| **В'ячеслав Ворона** | **Frontend Developer / UI Designer.** Розробка правої панелі статті, блоків контриб’юторів та джерел, оновлення дизайну сайту. |
| **Олег Довгаль** | **DevOps / Content.** Хостинг бекенду та БД, наповнення контентом (100 статей). |
| **Андрій Бухановський**| **Backend Developer.** Логіка реєстрації та автентифікації на сервері, історія редагувань. |
| **Артем Хрустальов** | **Co-Lead / Backend Developer.** Проєктування бази даних та розробка REST API ендпоінтів, робота над бекендом на Nest.js. |
